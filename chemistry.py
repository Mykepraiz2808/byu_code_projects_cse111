...
def make_periodic_table():
    """Return a dictionary containing the periodic table of the elements."""
    periodic_table = {
        "Ac": ["Actinium", 227],
        "Ag": ["Silver", 107.8682],
...
def compute_molar_mass(symbol_quantity_list, periodic_table):
    """Compute and return the total molar mass of the compound."""
    total_mass = 0.0
...
def main():
    try:
        # Known formula name lookup (extra credit feature)
        known_molecules = {
            "H2O": "Water",
            "CO2": "Carbon Dioxide",
            "O2": "Oxygen Gas",
        ...
        if formula in known_molecules:
            print(f"Compound name: {known_molecules[formula]}")
        ...
        print("Invalid number entered for mass.")
